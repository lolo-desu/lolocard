  ...
  <div class="fluid-container">
    ...
    <div class="content-container">
      ...
      <div class="note-paper">
        ...
        <p>但你<strong>必须保证酒馆助手版本为3.2.3以上</strong>，否则无法正常游玩</p>
        <p>
          链接是：<a
        ...
        <p>✅ claude 4.0 Sonnet - 完美兼容</p>
        <p>✅ gemini 2.5 Pro - 非常好用！但需要使用精简预设、注意防截断以及减少注意力占用才能完美运行</p>
        <p>✅ chatgpt-4o-latest - 文笔非常好！兼容性取决于预设</p>
        <p>✅ gpt 4.5 - 文笔超级超级好！完美兼容</p>
        <p>❓ Grok 3 - 不掉格式，但文风需要预设好好调整</p>
        <p>❓ DeepSeek - 新v3勉强能玩，R1祝你好运？</p>
        <br />
        <p>世界书部分内容涉及剧透，酌情观看</p>
        <br />
        <p><strong>可选界面设置：</strong></p>
        <p>🎨 选择框样式：开启条目即切换对应的选择框样式</p>
        <p>⚙️ 选择框设置：点击选择框时是会立即发送内容还是将内容放置在输入栏</p>
        <p>🌙 层间气泡的亮暗色请通过切换正则来更改</p>
        <p>抱歉，其余界面没有能力多做暗色设计了</p>
        <br />
        ...
        <p>🕛度过：快速度过时间直到你的选项</p>
        <p>🗺️地点：前往某一地点</p>
        <p>📊计数：由于使用了提示词模板，酒馆中的token计数虚高很多，想查看token数请使用这个</p>
      </div>
    </div>
    ...
    <div class="content-container">
      ...
      <div class="expandable-section" :class="{ expanded: expanded_sections.special_thanks }">
        <div class="note-section">
          ...
          <p>
            这张卡大量用到了酒馆助手的脚本功能，有兴趣可以研究一下，希望大家多用用前端注入功能以外的功能!（什么时候能来个简单易懂的教程啊x）
          </p>
      ...
      <div class="expandable-section" :class="{ expanded: expanded_sections.tutorial_plan }">
        <div class="note-section">
          ...
          <p>✅用sd-forge来跑卡内所有图片素材，非常简单省力，包括立绘和CG等</p>
          <p>✅使用大模型（效果不理想...）或 使用PS为跑出来的绿幕立绘快速抠图与调整...</p>
          <p>✅提示词模板分阶段人设及衍生的变量用：目前已经有mag的MVU框架</p>
    ...
    <div class="footer-wrapper">
      <nav class="navigation nav-bottom">
        <a href="https://rentry.org/lolodesu" class="nav-link" target="_blank">Rentry:络络导航站</a>
